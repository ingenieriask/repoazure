...
urlpatterns = [
    ...
    path('create-person/<int:pqrs_type>/', views.PersonCreateView.as_view(), name='create_person'),
    path('create-person-request/<int:pqrs_type>/', views.PersonRequestCreateView.as_view(), name='create_person_request'),
    path('edit-person/<int:pqrs_type>/<int:pk>/', views.PersonUpdateViewNew.as_view(), name='edit_person'),
    path('edit-person-request/<int:pqrs_type>/<int:pk>/', views.PersonUpdateViewNewRequest.as_view(), name='edit_person_request'),
    path('multi-request/<int:person>/', views.multi_create_request, name='multi_request'),
    path('delete-person/<int:pqrs_type>/<int:id>/',views.dete_person_request, name='delete_person_request'),
