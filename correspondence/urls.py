...
urlpatterns = [
    ...
    path('legal-person/create/', views.LegalPersonCreateView.as_view(), name='create_legal_person'),
    path('legal-person-update/<int:pk>/', views.LegalPersonUpdateView.as_view(), name='update_legal_person'),
